		...
		<Alert v-if="showAlert">
			<template v-slot:content>
				...
				<p class="alert__description">
					Вы уверены что хотите удалить комментарий? Данное дейтсвие являеться
					безвозратным.
				</p>
				<div class="alert__buttons">
					...
					<Button
						...
						text="Подтвердить"
						@click="handleDeleteReplyComment"
					/>
				</div>
			</template>
		</Alert>
		...
		<div class="comment__content">
			<div class="comment__header">
				...
				<div class="comment__actions">
					...
					<div v-if="isUserAuthorOfComment" class="comment__edit">
						<svg
							fill="#5357B6"
							width="14"
							height="14"
...
export default {
	...
	components: { CreateComment, Alert, Button },
	setup(props, context) {
		moment.locale("ru");
